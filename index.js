...
app.post('/login', function (request, response) {
  ...
  var pedido = {
    ...
    nombre: request.body.usuarioNombre,
    apellido: request.body.usuarioApellido,
    direccion: request.body.direccion,
    ciudad: request.body.ciudad,
    tarjetaNombre: request.body.tarjetaNombre,
    tarjetaNumero: request.body.tarjetaNumero,
    tarjetaExpir: request.body.tarjetaExpiracion,
    tarjetaCod: request.body.codigoTrajeta,
    fecha: new Date(),
    estado: 'nuevo',
